...
- `internal/sources/youtube` resolves queued YouTube and YouTube Music entries into cached decoded audio streams and preserves remote metadata for playback.
...
4. The active source resolver turns the queued item into a decoded playable stream and carries source metadata forward.
